...
- **Award types = grants + contracts** (codes 02/03/04/05 and A/B/C/D), specified
  explicitly. The USAspending geography endpoint under-counts if award types are left
  unset, so they are listed in full.
